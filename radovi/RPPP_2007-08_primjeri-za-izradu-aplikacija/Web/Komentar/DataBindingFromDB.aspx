<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DataBindingFromDB.aspx.cs" Inherits="DataBindingFromDB" %>
  ...
  <form id="form1" runat="server">
    <div>
      ...
      <asp:ListBox ID="lbxJezici" runat="server" Rows="7" SelectionMode="Multiple"
        DataSource=<%# DohvatiJezikeIzBaze() %>
        DataValueField="IdJezika" 
        DataTextField="NazJezika"
      >       
      </asp:ListBox>
      <br />
