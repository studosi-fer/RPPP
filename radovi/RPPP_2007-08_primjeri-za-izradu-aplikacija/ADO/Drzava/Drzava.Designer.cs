namespace Drzava
{
  partial class DrzavaForm
  {
    ...
    private void InitializeComponent()
    {
      ...
      this.drzavaTableAdapter = new Drzava.FirmaDataSetTableAdapters.DrzavaTableAdapter();
    ...
    private Drzava.FirmaDataSetTableAdapters.DrzavaTableAdapter drzavaTableAdapter;
